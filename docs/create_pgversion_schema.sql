...
CREATE ROLE hdus_cp WITH 
	...
	INHERIT
	ENCRYPTED PASSWORD '********'
	VALID UNTIL '2129-03-25 00:00:00';
-- ddl-end --

-- object: hdus_cp_cp | type: ROLE --
-- DROP ROLE IF EXISTS hdus_cp_cp;
CREATE ROLE hdus_cp_cp WITH 
	SUPERUSER
	INHERIT
	ENCRYPTED PASSWORD '********'
	VALID UNTIL '2129-03-25 00:00:00';
...
-- object: dbu_tb_ww_write | type: ROLE --
-- DROP ROLE IF EXISTS dbu_tb_ww_write;
CREATE ROLE dbu_tb_ww_write WITH 
	INHERIT
	ENCRYPTED PASSWORD '********'
	ROLE hdus;
-- ddl-end --

-- object: dbu_tb_ww_read | type: ROLE --
-- DROP ROLE IF EXISTS dbu_tb_ww_read;
CREATE ROLE dbu_tb_ww_read WITH 
	INHERIT
	ENCRYPTED PASSWORD '********'
	ROLE hdus;
-- ddl-end --

-- object: "peter.zopfi" | type: ROLE --
-- DROP ROLE IF EXISTS "peter.zopfi";
CREATE ROLE "peter.zopfi" WITH 
	INHERIT
	LOGIN
	ENCRYPTED PASSWORD '********';
-- ddl-end --

-- object: version | type: ROLE --
-- DROP ROLE IF EXISTS version;
CREATE ROLE version WITH 
	INHERIT
	ENCRYPTED PASSWORD '********';
-- ddl-end --

-- object: qwat_viewer | type: ROLE --
-- DROP ROLE IF EXISTS qwat_viewer;
CREATE ROLE qwat_viewer WITH 
	INHERIT
	ENCRYPTED PASSWORD '********';
-- ddl-end --

-- object: vmail | type: ROLE --
-- DROP ROLE IF EXISTS vmail;
CREATE ROLE vmail WITH 
	CREATEROLE
	INHERIT
	LOGIN
	ENCRYPTED PASSWORD '********';
...
-- object: pgversion_users | type: ROLE --
-- DROP ROLE IF EXISTS pgversion_users;
CREATE ROLE pgversion_users WITH 
	INHERIT
	ENCRYPTED PASSWORD '********';
-- ddl-end --

-- object: versions_admin | type: ROLE --
-- DROP ROLE IF EXISTS versions_admin;
CREATE ROLE versions_admin WITH 
	INHERIT
	ENCRYPTED PASSWORD '********';
-- ddl-end --

-- object: paul | type: ROLE --
-- DROP ROLE IF EXISTS paul;
CREATE ROLE paul WITH 
	INHERIT
	LOGIN
	ENCRYPTED PASSWORD '********';
-- ddl-end --
...
-- object: metadb | type: ROLE --
-- DROP ROLE IF EXISTS metadb;
CREATE ROLE metadb WITH 
	INHERIT
	ENCRYPTED PASSWORD '********'
	VALID UNTIL '2026-12-03 00:00:00'
	ROLE hdus;
-- ddl-end --

-- object: metadb_admin | type: ROLE --
-- DROP ROLE IF EXISTS metadb_admin;
CREATE ROLE metadb_admin WITH 
	INHERIT
	ENCRYPTED PASSWORD '********'
	ROLE hdus;
-- ddl-end --
...
-- object: hdus_cp1 | type: ROLE --
-- DROP ROLE IF EXISTS hdus_cp1;
CREATE ROLE hdus_cp1 WITH 
	SUPERUSER
	CREATEDB
	CREATEROLE
	INHERIT
...
-- object: hdus_cp_cp1 | type: ROLE --
-- DROP ROLE IF EXISTS hdus_cp_cp1;
CREATE ROLE hdus_cp_cp1 WITH 
	SUPERUSER
	INHERIT
	ENCRYPTED PASSWORD '********'
	VALID UNTIL '2129-03-25 00:00:00';
...
-- object: grant_2d1e4164b5 | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA versions
   TO versions;
-- ddl-end --

-- object: grant_d91b38d78b | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA versions
   TO postgres;
-- ddl-end --

-- object: grant_ff0b79c39e | type: PERMISSION --
GRANT CREATE,USAGE
   ON SCHEMA versions
   TO PUBLIC;
-- ddl-end --

-- object: grant_61c7503814 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvscheck(character varying)
   TO versions;
-- ddl-end --

-- object: grant_8378db10c4 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvscheckout(IN character varying,IN bigint)
   TO versions;
-- ddl-end --

-- object: grant_658b1a9a08 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvscommit(character varying,text)
   TO versions;
-- ddl-end --

-- object: grant_197eae0f8a | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsdrop(character varying)
   TO versions;
-- ddl-end --

-- object: grant_04ea4db37b | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsinit(character varying)
   TO versions;
-- ddl-end --

-- object: grant_0f076eb6b6 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvslogview(character varying)
   TO versions;
-- ddl-end --

-- object: grant_6f8b7748b0 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsmerge(character varying,integer,character varying)
   TO versions;
-- ddl-end --

-- object: grant_f408024818 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsrevert(character varying)
   TO versions;
-- ddl-end --

-- object: grant_607b6585c7 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsrevision()
   TO versions;
-- ddl-end --

-- object: grant_3e72071595 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvsrollback(character varying,integer)
   TO versions;
-- ddl-end --

-- object: grant_b6a2a3b06e | type: PERMISSION --
GRANT SELECT,INSERT,UPDATE,DELETE,TRUNCATE,REFERENCES,TRIGGER
   ON TABLE versions.version_tables_logmsg
   TO versions;
-- ddl-end --

-- object: grant_71510b3b27 | type: PERMISSION --
GRANT SELECT,INSERT,UPDATE,DELETE,TRUNCATE,REFERENCES,TRIGGER
   ON TABLE versions.version_tables
   TO versions;
-- ddl-end --

-- object: grant_aec018b41d | type: PERMISSION --
GRANT SELECT,INSERT,UPDATE,DELETE,TRUNCATE,REFERENCES,TRIGGER
   ON TABLE versions.version_tags
   TO versions;
-- ddl-end --

-- object: grant_e3170db26b | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions._primarykey(IN character varying)
   TO versions;
-- ddl-end --

-- object: grant_11300a6440 | type: PERMISSION --
GRANT EXECUTE
   ON FUNCTION versions.pgvs_version_record()
   TO versions;
-- ddl-end --

-- object: grant_dc974509e6 | type: PERMISSION --
GRANT EXECUTE
...
-- object: grant_d31004734e | type: PERMISSION --
GRANT USAGE
   ON TYPE versions.checkout
   TO versions;
-- ddl-end --

-- object: grant_911aaf609e | type: PERMISSION --
GRANT USAGE
   ON TYPE versions.conflicts
   TO versions;
-- ddl-end --

-- object: grant_01f6f14ede | type: PERMISSION --
GRANT USAGE
