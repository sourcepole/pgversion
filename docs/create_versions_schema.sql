--
-- create_versions_schema.sql revision 2.0 2016-12-01 20:42
--
--
...
CREATE OR REPLACE FUNCTION versions.pgvscommit(character varying, text)
...
CREATE OR REPLACE FUNCTION versions.pgvsdiff(_rowtype anyelement, revision integer)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
...
CREATE OR REPLACE FUNCTION versions.pgvslogview(character varying)
...
CREATE OR REPLACE FUNCTION versions.pgvscheckout(intable character varying, revision bigint)
